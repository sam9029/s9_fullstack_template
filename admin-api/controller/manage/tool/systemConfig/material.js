const model = require("../../../../model/manage/tool/systemConfig/material")
...
exports.config = (req, res) => {
  model.config(req.query, req.$user).then(data => res.send(data)).catch(err => res.send(res.errorFormat(err)));
}
