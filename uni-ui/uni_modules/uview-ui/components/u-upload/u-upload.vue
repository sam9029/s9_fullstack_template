	...
	<view class="u-upload" :style="[$u.addStyle(customStyle)]">
  	  ...
  	  <view class="camera-auth">
				...
				<view class="camera-auth--bottom u-flex-row u-row-center u-col-center">
					<u-button color="#F6F6F6" class="u-m-r-28" @click="handleAuthClose" :customStyle="{ color: '#3C3C3C', 'border-radius': '16rpx' }">我知道了</u-button>
					<u-button type="primary" @click="handleAuthSetting" :customStyle="{ 'border-radius': '16rpx' }">前往设置</u-button>
				</view>
  	  </view>
  	</u-modal>
	</view>
