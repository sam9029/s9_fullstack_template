<template>
  <view class="create-income-detail">
        ...
        <view class="u-flex-col widthAll u-m-l-16">
          ...
          <view class="price-card u-border-radius">
            ...
            <view class="u-flex-col u-col-center price-border">
              <text class="color-text-black u-font-28 u-line-h-44">{{
                unitMoney(detailObj.exchange_amount, false, true)
              }}</text>
              <text class="color-text-less-grey u-font-22 u-line-h-40"
                >兑换金额</text
              >
            ...
            <view class="u-flex-col u-col-center">
			  ...
			  <view class="u-flex-1 u-flex-col u-row-center" @click="showModal=true">
				  <u-icon label="我的收益" labelSize="22rpx" labelColor="#989898" :name="`${static_path}icon_gray_qs.png`" width="24rpx" height="24rpx" labelPos="left"></u-icon>
			  </view>
            </view>
          </view>
        </view>
          ...
          <view class="income-popup-grid u-p-y-16 widthAll u-border-radius">
            <view class="u-flex-col u-col-center">
              <text
                ...
                >{{ unitMoney(currentIncome.exchange_amount, false, true) }}</text
              >
              <text class="color-text-less-grey u-font-22 u-line-h-40"
                >兑换金额</text
              >
	...
	<u-modal
		...
		title="我的收益"
		content="我的收益即看点支付分成收益，包含待入账预估收益和累计入账收益。"
		confirmText="我知道了"
		:buttonFill="false"
...
import {
  getkdCreateDetailTotal,
  getkdCreateDetailList,
