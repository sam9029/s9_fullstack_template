<template>
  <view class="mine-page">
    <view class="tab-area u-flex-row u-col-center u-row-right">
      ...
      <u-icon
        v-show="has_login"
        :name="`${static_path}mine_scan_icon.png`"
        class="u-m-l-32"
        size="24"
        @click="goScan"
      ></u-icon>
    ...
    <view
      class="login-area u-m-t-44 u-m-b-48 u-flex-row u-row-between u-col-center"
    >
      <view class="u-flex-row u-col-center u-m-r-32">
        <view class="avatar-box u-m-r-32" @click="goLogin">
          <u-avatar
            :src="userInfo.avatar || `${static_path}no_avatar.png`"
            shape="circle"
            size="60"
          ></u-avatar>
        </view>
        <view
          @click="goLogin"
          v-show="!has_login"
          class="info-box u-flex-col u-row-center u-m-r-32"
        >
        ...
        <view v-show="has_login" class="info-box u-flex-col u-row-center">
          <view class="u-flex-row u-col-center u-m-b-16">
            ...
            <view v-if="account_type == 2" class="tag u-m-l-16">
              <u--image
                :src="`${static_path}tougu_icon.png`"
                width="12"
                height="12"
              ></u--image>
              <text class="u-font-20 u-line-h-36 color-text-primary u-m-l-8"
                >投顾</text
              >
            </view>
            <view v-if="account_type == 1" class="tag u-m-l-16">
              <u--image
                :src="`${static_path}daren_icon.png`"
                width="12"
                height="12"
              ></u--image>
              <text class="u-font-20 u-line-h-36 color-text-primary u-m-l-8"
      ...
      <u-icon
        size="24"
        color="#2c2c2c"
        :name="has_login ? `${static_path}edit_icon.png` : `arrow-right`"
        @click="goLogin"
      ></u-icon>
    </view>
    <view
      class="auth-area u-p-t-16 u-p-b-16 u-p-l-32 u-p-r-32 u-m-b-28 u-flex-row u-row-between u-col-center"
      :style="{
    ...
    >
      <view class="auth-area--left u-flex-col u-row-center">
        <u--image
          :src="`${static_path}creater_icon.png`"
          class="u-m-r-8"
          width="227"
          height="24"
        ></u--image>
        <text class="u-font-20 u-line-h-32" style="color: #92a2b2"
          >认证创作者享受专属权益</text
        >
      </view>
      <view
        class="auth-area--right u-p-l-24 u-p-r-24 u-p-t-8 u-p-b-8"
        style="background: #d1e3ff; border-radius: 100px"
        @click="gotoRealname"
      >
        <text class="u-font-24 u-line-h-40 u-font-bold" style="color: #161b1f"
          >去认证</text
        >
      </view>
    </view>
    <view class="function-btns u-m-b-28">
      ...
      >
        <u--image
          class="u-m-b-8"
          :src="`${static_path}my_income_icon.png`"
          width="40"
          height="40"
        ></u--image>
        <text class="u-font-24 u-line-h-40" style="color: #3c3c3c"
          >我的收益</text
        >
      </view>
      <view
      ...
      >
        <u--image
          class="u-m-b-8"
          :src="`${static_path}my_account_icon.png`"
          width="40"
          height="40"
        ></u--image>
        <text class="u-font-24 u-line-h-40" style="color: #3c3c3c"
      ...
      >
        <u--image
          class="u-m-b-8"
          :src="`${static_path}learn_center_icon.png`"
          width="40"
          height="40"
        ></u--image>
        <text class="u-font-24 u-line-h-40" style="color: #3c3c3c"
    ...
    <view class="menu-area u-border-primary u-bg-f u-p-32">
      <view
        ...
        :class="{ 'u-border-custom-bottom': index !== menuItems.length - 1 }"
        :style="{
