<template>
  <view class="novel-page-box u-vh-100">
    ...
    ></saveQrCode>
    <view
      class="top-navbar-box"
      :class="{ 'top-navbar-box-bg': bg_active }"
      id="top-navbar-box"
    >
      <view class="top_status widthAll"></view>
      <view
        class="top-navbar-header widthAll u-flex-row u-flex-start u-p-t-16 u-p-b-16 u-p-l-28 u-p-r-28"
      >
        <view
          class="top-navbar-icon u-flex-col u-row-center u-col-center u-bg-f u-m-r-16"
        >
          <u-icon
            name="arrow-left"
            color="#1A1A1A"
    ...
    <view class="top-box" id="top-box">
      <view
        class="top-bg u-flex-col u-row-right u-p-l-28 u-p-r-28"
        ...
        <text class="u-m-b-16 u-font-24 color-text-less-grey">{{
          pageDes
			...
			<view class="task-title-num u-m-t-40 u-p-l-28 u-m-b-28 u-p-r-28 widthAll">
				<text class="u-font-32 u-font-weight-600 color-text-black">{{ taskCountTitle }}</text>
			</view>
		</view>
			...
			<view v-for="item in listData" :key="item.advertiser_id"
				...
				<view class="novel-list-item-top u-flex">
					<view class="novel-list-item-top-left u-flex-col  heightAll">
						<text
							class="novel-list-item-top-left-title u-font-28 u-font-weight-600 color-text-black">{{ item.qr_name || item.task_name}}</text>
						<text class="u-font-22 color-text-grey">{{
              `投稿周期： ${item.start_date} - ${item.end_date}`
            }}</text>
					</view>
...
<script>
import { getJuXingTaskList, getXingTuTaskList } from "./api/index.js";
