<template>
	<view class="invite-page">
		...
		<template v-else>
			<MyNavbar bgColor="#d3edff">
				<template #navbarData>
					<view class="u-flex-row u-row-center u-col-center">
						<text class="u-text-center u-font-32 color-text-black">邀请好友</text>
					</view>
				</template>
			</MyNavbar>
			...
			<view class="invite-page--container u-p-l-56 u-p-r-56">
				<view id="save-area" ref="save-area" class="save-area u-bg-f u-m-b-28">
					<u--image class="invite-bg" :src="`${static_path}invite_bg.png`" width="100%"
					...
					<view class="u-p-32">
						<view class="avatar-area u-p-b-32 u-flex-row u-col-center">
							...
							<view class="u-flex-col u-m-l-32">
								...
								<text class="color-text-less-grey u-font-22 u-line-h-40">邀请你加入欢乐创APP</text>
							</view>
						</view>
						<view class="qr-area u-flex-row u-row-between u-col-center u-p-t-32">
							<view class="qr-area--left u-flex-col">
								<text class="color-text-primary u-font-bold u-font-40 u-line-h-56"
									style="font-style: italic">HEY~</text>
							...
							<view class="qr-area--right">
								<QrCode :qrValue="inviteInfo.qr_link" :size="144" sizeUnit="rpx" :options="qrOptions"
				...
				<view class="invite-info u-bg-f u-m-b-28 u-p-32">
					...
					<ul class="u-font-24 color-text-less-grey u-line-h-40 u-m-t-16" style="padding-left: 32rpx">
						<li>
				...
				<view class="invite-num u-flex-row u-row-between u-col-center u-p-32 u-bg-f" @click="goDetail">
					<view class="u-flex-row u-col-center">
						<u--image :src="`${static_path}invite_success_icon.png`" width="48rpx" height="48rpx"></u--image>
			...
			<canvas id="saveCanvas" canvas-id="saveCanvas" :style="{
					width: '638px',
					height: '742px',
					position: 'fixed',
					left: '-9999px',
			...
			<BottomBtn :data="button_list" :buttonIndex="0" @save="onSave" @copy="onCopy" @height="getHeight" />
